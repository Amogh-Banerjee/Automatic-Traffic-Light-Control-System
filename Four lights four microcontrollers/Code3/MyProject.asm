...
L_main18:
;MyProject.c,120 :: 		P2.B0 = 0;
	CLR P2+0
;MyProject.c,121 :: 		P2.B2 = 1;
	SETB P2+0
;MyProject.c,122 :: 		countAndCheck(10);
	MOV FARG_countAndCheck_count+0, #10
	MOV FARG_countAndCheck_count+1, #0
	LCALL _countAndCheck+0
;MyProject.c,123 :: 		P2.B2 = 0;
	CLR P2+0
;MyProject.c,124 :: 		P2.B1 = 1;
	SETB P2+0
;MyProject.c,125 :: 		countAndCheck(10);
	MOV FARG_countAndCheck_count+0, #10
	MOV FARG_countAndCheck_count+1, #0
	LCALL _countAndCheck+0
;MyProject.c,126 :: 		P2.B1 = 0;
	CLR P2+0
;MyProject.c,127 :: 		P2.B0 = 1;
	SETB P2+0
;MyProject.c,128 :: 		countAndCheck(20);
